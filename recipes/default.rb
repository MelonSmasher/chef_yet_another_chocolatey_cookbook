...
if not node['yacc']['install_options'].empty?
  ...
  if node['yacc']['install_options'].kind_of?(Array)
  ...
  elsif node['yacc']['install_options'].kind_of?(String)
